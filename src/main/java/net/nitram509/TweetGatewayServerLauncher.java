...
public class TweetGatewayServerLauncher {
  ...
  private static FilterHolder createRestJerseyFilterHolder() {
    ...
    filterHolder.getInitParameters().put("com.sun.jersey.config.property.packages", "net.nitram509.controller net.nitram509.gateways.controller net.nitram509.page.index");
